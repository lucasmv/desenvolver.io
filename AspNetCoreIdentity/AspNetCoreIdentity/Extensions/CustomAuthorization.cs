...
namespace AspNetCoreIdentity.Extensions {
    ...
    public class ClamisAuthorizeAttribute : TypeFilterAttribute {
        public ClamisAuthorizeAttribute(string claimName, string claimValue) : base(typeof(RequisitoClaimFilter)) {
